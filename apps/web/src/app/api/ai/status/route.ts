  ...
  return NextResponse.json({
    ...
    data: {
      ...
      models: [
        ...
        { model: 'Ollama/Qwen2.5', available: false, specialty: 'محلي — غير متاح على السحابة' },
        { model: 'Bedrock/Claude 3.5 Sonnet', available: false, specialty: 'مؤسسي — يتطلب AWS credentials' },
      ],
