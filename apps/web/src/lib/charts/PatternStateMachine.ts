...
function checkTransition(
 ...
 messageAr: `pattern ${info.type} points phase verification`,
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} certain — price within who PRZ`,
 direction: info.direction,
 priority: 'medium',
 keyLevel: info.keyLevel,
 state: 'active',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} — price level cancellation`,
 direction: info.direction,
 priority: 'high',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} — price movement who PRZ`,
 direction: info.direction,
 priority: 'critical',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} — level cancellation bearish`,
 direction: info.direction,
 priority: 'high',
 keyLevel: info.stopLoss,
 state: 'failed',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} — level cancellation bullish`,
 direction: info.direction,
 priority: 'high',
 keyLevel: info.stopLoss,
 state: 'failed',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} certain success — price goal`,
 direction: info.direction,
 priority: 'critical',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} after — price bearish`,
 direction: info.direction,
 priority: 'high',
 keyLevel: info.stopLoss,
 state: 'failed',
 ...
 alert: {
 patternType: info.type,
 messageAr: `pattern ${info.type} after — price bullish`,
 direction: info.direction,
 priority: 'high',
 keyLevel: info.stopLoss,
 state: 'failed',
...
export function getPatternStateMachine(): PatternStateMachine {
 ...
 alerts.push({
 patternType: info.type,
 messageAr: `pattern ${info.type} new certain (${direction === 'bullish' ? 'bullish' : direction === 'bearish' ? 'bearish' : 'neutral'})`,
 direction,
 priority: 'high',
 keyLevel: entryPrice,
 state: 'active',
