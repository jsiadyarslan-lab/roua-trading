    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontFamily: "var(--font-ar)", fontSize: 13, color: 'var(--foreground)', fontWeight: 800 }}>
        ...
        <>
          ...
          {activeBriefs.length > 0 && (
            <div style={{ padding: '8px 10px', background: 'rgba(0,212,255,0.05)', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,212,255,0.15)', marginBottom: 4 }}>
              <div style={{ fontSize: 11, color: 'rgba(0,212,255,0.8)', fontWeight: 700, marginBottom: 6, letterSpacing: 1 }}>🏛️ {t('councilSignals')}</div>
              {activeBriefs.map((b: any, i: number) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '2px 0', fontSize: 11, borderTop: i > 0 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  <span style={{ color: b.direction === 'BUY' ? '#00FFA3' : '#FF4757', fontWeight: 800 }}>{b.direction === 'BUY' ? '▲' : '▼'} {b.pair}</span>
                  <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11 }}>{b.timeframe}</span>
          ...
          <div style={{ display: 'flex', gap: compact ? 8 : 10 }}>
            <div style={{
               ...
               <span style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 700 }}>{t('overallTrend')}</span>
            ...
            <div style={{
               ...
               <span style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 700 }}>{t('riskLevel')}</span>
               <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: 11, color: 'var(--text-muted-safe)', fontWeight: 800 }}>{t('digitalConfidenceIndex')}</span>
          ...
          {!compact && <div style={{
            ...
            borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,229,255,0.1)'
             ...
             <span style={{ fontSize: 11, color: 'var(--accent)', fontWeight: 800, marginBottom: 4 }}>{t('analysisSteps')}</span>
             {[
               ...
               <div key={si} style={{ display: 'flex', alignItems: 'center', gap: 8, opacity: step.status === 'checked' ? 1 : 0.4 }}>
                  ...
                  <span style={{ fontSize: 11, color: 'var(--text2)', fontFamily: "var(--font-ar)" }}>{step.label}</span>
               </div>
             ))}
          </div>}
          ...
          >
             ...
             {!expanded && (
               <div style={{
                  ...
                  display: 'flex', justifyContent: 'center', alignItems: 'flex-end', fontSize: 11, color: 'var(--accent)', fontWeight: 800
               }}>{t('tapToExpand')}</div>
             )}
          </div>
          ...
          {showRecommendation && (
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, color: 'var(--accent)', fontWeight: 800, display: 'flex', alignItems: 'center', gap: 4 }}>
