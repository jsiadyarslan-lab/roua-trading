...
import { CouncilIntelligenceModule } from '../../modules/ai/council-intelligence/council-intelligence.module'; // V441: Agent needs TradeJournalService
...
@Module({
  imports: [
    ...
    CouncilIntelligenceModule,  // V441: Agent needs TradeJournalService
  ],
