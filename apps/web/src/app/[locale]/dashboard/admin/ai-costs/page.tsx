    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          return (
            <div key={i} style={{
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ fontSize: 9, color: `${card.color}99`, fontFamily: "var(--font-ar)", marginTop: 1 }}>{card.sub}</div>
              </div>
            </div>
          )
        })}
      ...
      <div style={{ ...CARD_STYLE, padding: 0 }}>
        <div style={{
          ...
          <span style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)", marginRight: 8 }}>نشط = طلب خلال آخر ساعة</span>
        </div>
        <div style={{ padding: 12, display: 'flex', flexWrap: 'wrap', gap: 8 }}>
          {loading ? (
            <div style={{ padding: 20, textAlign: 'center', color: COLORS.muted, fontFamily: "var(--font-ar)", fontSize: 12, width: '100%' }}>
              جارٍ التحميل...
            </div>
              ...
              return (
                <div key={p.provider} style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>النماذج</div>
                      <div style={{ fontSize: 13, fontWeight: 700, color: color, fontFamily: "var(--font-mono)" }}>{p.models}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>الطلبات</div>
                      <div style={{ fontSize: 13, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-mono)" }}>{p.requests.toLocaleString()}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>توكن مدخلة</div>
                      <div style={{ fontSize: 12, fontWeight: 600, color: COLORS.blue, fontFamily: "var(--font-mono)" }}>{formatTokens(p.inputTokens)}</div>
                    </div>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>توكن مخرجة</div>
                      <div style={{ fontSize: 12, fontWeight: 600, color: COLORS.teal, fontFamily: "var(--font-mono)" }}>{formatTokens(p.outputTokens)}</div>
                    </div>
                  </div>
                  <div style={{ marginTop: 8, paddingTop: 8, borderTop: `1px solid ${COLORS.border}` }}>
                    <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>التكلفة الإجمالية</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: COLORS.amber, fontFamily: "var(--font-mono)" }}>{formatCost(p.cost)}</div>
                  </div>
                </div>
              )
            })
      ...
      <div style={{ ...CARD_STYLE, padding: 0 }}>
        <div style={{
          ...
          <span style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>انقر على عنوان العمود للترتيب</span>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
              <thead>
                <tr style={{ borderBottom: `1px solid ${COLORS.border}` }}>
                  ...
                  <th style={{ padding: '10px 12px', textAlign: 'right', fontSize: 10, fontWeight: 700, color: COLORS.muted, fontFamily: "var(--font-ar)", whiteSpace: 'nowrap' }}>الأخطاء</th>
                  <th style={{ padding: '10px 12px', textAlign: 'right', fontSize: 10, fontWeight: 700, color: COLORS.muted, fontFamily: "var(--font-ar)", whiteSpace: 'nowrap' }}>النجاح</th>
                  <th style={{ padding: '10px 12px', textAlign: 'right', fontSize: 10, fontWeight: 700, color: COLORS.muted, fontFamily: "var(--font-ar)", whiteSpace: 'nowrap' }}>آخر استخدام</th>
                  <th style={{ padding: '10px 12px', textAlign: 'right', fontSize: 10, fontWeight: 700, color: COLORS.muted, fontFamily: "var(--font-ar)", whiteSpace: 'nowrap' }}>الحالة</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr key={m.model} style={{
                      ...
                      <td style={{ padding: '10px 12px' }} dir="ltr">
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-mono)" }}>{getProviderLabel(m.provider)}</div>
                          </div>
                        </div>
                      </td>
                      <td style={{ padding: '10px 12px' }}>
                        ...
                        {costPer1KInput > 0 && (
                          <div style={{ fontSize: 8, color: COLORS.muted, fontFamily: "var(--font-mono)" }}>
                      ...
                      <td style={{ padding: '10px 12px', fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)", whiteSpace: 'nowrap' }}>
                        {timeAgo(m.lastUsed)}
                      </td>
                      <td style={{ padding: '10px 12px' }}>
                        <span style={{
      ...
      <div style={{ ...CARD_STYLE, padding: 0 }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)", marginRight: 8 }}>آخر 30 يوم</span>
          </div>
              ...
              <div style={{ position: 'relative' }}>
                  ...
                  {dailyEntries.map(([date, cost], i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {i % 5 === 0 && (
                          <span style={{ fontSize: 7, color: COLORS.muted, fontFamily: "var(--font-mono)", whiteSpace: 'nowrap' }}>
                            {date.slice(5)}
                          </span>
                        )}
                      </div>
                ...
                {tooltipInfo && chartMode === 'cost' && (
                  <div style={{
                    ...
                    <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-mono)" }}>{tooltipInfo.date}</div>
                    <div style={{ fontSize: 13, fontWeight: 700, color: COLORS.amber, fontFamily: "var(--font-mono)" }}>{tooltipInfo.cost}</div>
                    <div style={{ fontSize: 9, color: COLORS.blue, fontFamily: "var(--font-ar)" }}>مدخلة: {tooltipInfo.inputTokens}</div>
                    <div style={{ fontSize: 9, color: COLORS.teal, fontFamily: "var(--font-ar)" }}>مخرجة: {tooltipInfo.outputTokens}</div>
                  </div>
                )}
              </div>
            )
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ display: 'flex', gap: 16, marginBottom: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    <span style={{ fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>توكن مدخلة</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    <div style={{ width: 10, height: 10, borderRadius: 2, background: COLORS.teal }} />
                    <span style={{ fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>توكن مخرجة</span>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: 3, height: 160, paddingTop: 8 }}>
                ...
                {tooltipInfo && chartMode === 'tokens' && (
                  <div style={{
                    ...
                    <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-mono)" }}>{tooltipInfo.date}</div>
                    <div style={{ fontSize: 12, fontWeight: 700, color: COLORS.blue, fontFamily: "var(--font-mono)" }}>مدخلة: {tooltipInfo.inputTokens}</div>
                    <div style={{ fontSize: 12, fontWeight: 700, color: COLORS.teal, fontFamily: "var(--font-mono)" }}>مخرجة: {tooltipInfo.outputTokens}</div>
                    <div style={{ fontSize: 10, color: COLORS.amber, fontFamily: "var(--font-mono)" }}>التكلفة: {tooltipInfo.cost}</div>
                    <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>الطلبات: {tooltipInfo.requests}</div>
                  </div>
                )}
              </div>
            )
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        ...
        <div style={{ ...CARD_STYLE, padding: 0 }}>
          ...
          <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 8, maxHeight: 360, overflowY: 'auto' }}>
            {loading ? (
              <div style={{ padding: 20, textAlign: 'center', color: COLORS.muted, fontFamily: "var(--font-ar)", fontSize: 12 }}>
                جارٍ التحميل...
              </div>
                ...
                return (
                  <div key={ep.endpoint} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                      <span style={{ fontSize: 12, fontWeight: 600, color: COLORS.text, fontFamily: "var(--font-ar)" }}>
                    ...
                    <div style={{ display: 'flex', gap: 12, fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)", marginBottom: 6 }}>
            ...
            {loading ? (
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.blue, fontFamily: "var(--font-ar)" }}>مدخلة</div>
                    ...
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.teal, fontFamily: "var(--font-ar)" }}>مخرجة</div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
                    <span style={{ fontSize: 8, color: COLORS.blue, fontFamily: "var(--font-ar)" }}>
                      {monthInputTokens + monthOutputTokens > 0 ? Math.round((monthInputTokens / (monthInputTokens + monthOutputTokens)) * 100) : 0}% مدخلة
                    </span>
                    <span style={{ fontSize: 8, color: COLORS.teal, fontFamily: "var(--font-ar)" }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>توكن اليوم</div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-mono)" }}>
                        {formatTokens(todayInputTokens + todayOutputTokens)}
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: 9, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>المتوسط اليومي</div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: COLORS.muted, fontFamily: "var(--font-mono)" }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>التكلفة لكل 1K توكن مدخلة</span>
                      <span style={{ fontSize: 12, fontWeight: 700, color: COLORS.blue, fontFamily: "var(--font-mono)" }}>
                        {monthInputTokens > 0 ? formatCost((data?.summary.month.cost ?? 0) / monthInputTokens * 1000) : '—'}
                      </span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>التكلفة لكل 1K توكن مخرجة</span>
                      <span style={{ fontSize: 12, fontWeight: 700, color: COLORS.teal, fontFamily: "var(--font-mono)" }}>
                        {monthOutputTokens > 0 ? formatCost((data?.summary.month.cost ?? 0) / monthOutputTokens * 1000) : '—'}
                      </span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: 10, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>نسبة المدخلة/المخرجة</span>
                      <span style={{ fontSize: 12, fontWeight: 700, color: COLORS.accent, fontFamily: "var(--font-mono)" }}>
