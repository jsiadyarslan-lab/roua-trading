...
function getClassicLabelAr(patternType: string): string {
 ...
 'HEAD_AND_SHOULDERS': ' in',
 'INVERSE_HEAD_AND_SHOULDERS': ' in with',
 'DOUBLE_TOP': 'high ',
 'DOUBLE_BOTTOM': 'low ',
 'ASCENDING_TRIANGLE': 'triangle bullish',
 'DESCENDING_TRIANGLE': 'triangle bearish',
 'SYMMETRICAL_TRIANGLE': 'triangle what',
 'EXPANDING_TRIANGLE': 'triangle ninth',
 'RISING_WEDGE': 'in bullish',
 'FALLING_WEDGE': 'in bearish',
 };
...
function smcToAIPatterns(smcData: ReturnType<typeof detectSMC>): AIPattern[] {
 ...
 labelAr: ob.type === 'bullish' ? 'but ' : 'but ',
 time: ob.time,
...
function srLevelsToAIPatterns(srLevels: ReturnType<typeof detectSRLevels>): AIPattern[] {
 ...
 labelAr: level.type === 'support' ? 'support' : 'resistance',
