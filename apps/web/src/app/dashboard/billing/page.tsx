...
import {
  ...
  Radio, Code2, Headphones, Infinity, Copy, Eye, EyeOff
} from 'lucide-react'
...
const PLANS: PlanData[] = [
  {
    ...
    price: 0,
    period: 'شهر',
    description: 'ابدأ رحلتك في عالم التداول مع الأدوات الأساسية. مثالي للمبتدئين الذين يريدون استكشاف الأسواق والتعلم عبر التداول الورقي قبل المخاطرة بأموال حقيقية. يمنحك إشارات أساسية وتحليلات محدودة لفهم حركة السوق.',
    color: T.text2,
    gradient: 'linear-gradient(135deg, #94a3b8, #64748b)',
    icon: <Crown size={22} />,
    features: [
      { icon: <BarChart3 size={13} />, label: 'تداول ورقي (Paper Trading)', included: true },
      { icon: <Radio size={13} />, label: 'إشارات أساسية محدودة', included: true },
      { icon: <Eye size={13} />, label: 'تحليلات محدودة للسوق', included: true },
      { icon: <Brain size={13} />, label: 'رؤى AI أساسية', included: true },
      { icon: <Zap size={13} />, label: 'تداول حقيقي', included: false },
      { icon: <Copy size={13} />, label: 'نسخ الصفقات', included: false },
  ...
  },
  {
    ...
    price: 29,
    period: 'شهر',
    description: 'افتح الإمكانيات الحقيقية للتداول مع خطة برو المصممة للمتداولين الجادين. استمتع بتداول حقيقي مع ذكاء اصطناعي متقدم يحلل الأسواق على مدار الساعة. بيانات حية مباشرة تضمن لك اتخاذ قرارات مبنية على معلومات دقيقة ولحظية.',
    color: T.cyan,
    gradient: 'linear-gradient(135deg, #00D4FF, #0A84FF)',
    icon: <Star size={22} />,
    popular: true,
    features: [
      { icon: <Zap size={13} />, label: 'تداول حقيقي كامل', included: true },
      { icon: <Brain size={13} />, label: 'AI متقدم مع تداول تلقائي', included: true },
      { icon: <Globe size={13} />, label: 'بيانات حية مباشرة', included: true },
      { icon: <BarChart3 size={13} />, label: 'تداول ورقي غير محدود', included: true },
      { icon: <Shield size={13} />, label: 'رافعة مالية عالية', included: true },
      { icon: <Radio size={13} />, label: 'ماسح ذكي للأسواق', included: true },
      { icon: <Copy size={13} />, label: 'نسخ الصفقات', included: true },
      { icon: <Code2 size={13} />, label: 'وصول API', included: false },
    ],
  },
  {
    ...
    price: 79,
    period: 'شهر',
    description: 'الخطة المثالية للمتداولين المحترفين الذين يتطلبون أدوات متقدمة ووصول شامل. نسخ صفقات أفضل المتداولين تلقائياً، واستخدم نماذج AI المتقدمة التي تتعلم من أنماط السوق المعقدة. وصول كامل عبر API لبناء استراتيجياتك الخاصة وأدواتك المخصصة.',
    color: T.amber,
    gradient: 'linear-gradient(135deg, #FFB800, #FF8C00)',
    icon: <Sparkles size={22} />,
    badge: 'الأكثر قيمة',
    features: [
      { icon: <Copy size={13} />, label: 'نسخ صفقات النخبة', included: true },
      ...
      { icon: <Shield size={13} />, label: 'إدارة مخاطر متقدمة', included: true },
      { icon: <BarChart3 size={13} />, label: 'تحليلات محفظة متقدمة', included: true },
      { icon: <Users size={13} />, label: 'تداول اجتماعي كامل', included: true },
      { icon: <Download size={13} />, label: 'تصدير البيانات', included: true },
    ],
  },
  {
    id: 'INSTITUTIONAL',
    ...
    price: 299,
    period: 'شهر',
    description: 'الحل الشامل للمؤسسات والصناديق الاستثمارية التي تحتاج إلى قوة حوسبية لا محدودة ودعم مخصص على مدار الساعة. يتميز بحدود استخدام غير محدودة، تكامل Webhooks للأنظمة الداخلية، ومدير حساب مخصص يعمل مع فريقك لتحقيق أهدافكم الاستثمارية.',
    color: T.green,
    gradient: 'linear-gradient(135deg, #00FFA3, #00CC82)',
    icon: <Building2 size={22} />,
    features: [
      { icon: <Infinity size={13} />, label: 'بدون أي حدود', included: true },
      ...
      { icon: <Users size={13} />, label: 'حسابات متعددة', included: true },
...
const BILLING_HISTORY: BillingRecord[] = [
  { id: 'INV-2026-001', date: '2026/02/28', description: 'اشتراك خطة برو — مارس 2026', amount: '$29.00', status: 'paid', statusLabel: 'مدفوع' },
  { id: 'INV-2026-002', date: '2026/01/28', description: 'اشتراك خطة برو — فبراير 2026', amount: '$29.00', status: 'paid', statusLabel: 'مدفوع' },
  { id: 'INV-2025-012', date: '2025/12/28', description: 'اشتراك خطة برو — يناير 2026', amount: '$29.00', status: 'paid', statusLabel: 'مدفوع' },
  { id: 'INV-2025-011', date: '2025/11/28', description: 'اشتراك خطة متميز — ديسمبر 2025', amount: '$79.00', status: 'refunded', statusLabel: 'مسترد' },
  { id: 'INV-2025-010', date: '2025/10/28', description: 'اشتراك خطة متميز — نوفمبر 2025', amount: '$79.00', status: 'paid', statusLabel: 'مدفوع' },
  { id: 'INV-2025-009', date: '2025/09/15', description: 'ترقية من برو إلى متميز', amount: '$50.00', status: 'paid', statusLabel: 'مدفوع' },
  { id: 'INV-2025-008', date: '2025/08/28', description: 'اشتراك خطة برو — سبتمبر 2025', amount: '$29.00', status: 'failed', statusLabel: 'فشل' },
  { id: 'INV-2025-007', date: '2025/07/28', description: 'اشتراك خطة برو — أغسطس 2025', amount: '$29.00', status: 'paid', statusLabel: 'مدفوع' },
]
