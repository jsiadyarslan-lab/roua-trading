...
function getFallbackNews() {
  return [
    { category: 'Fed', categoryAr: 'الاحتياطي', categoryFr: 'Fed', categoryTr: 'Fed', categoryEs: 'Reserva Federal', color: T.gold, bgColor: '#d4af3712', text: 'Federal Reserve signals potential rate cuts in Q3', textAr: 'الاحتياطي الفيدرالي يشير إلى خفض محتمل للفائدة في الربع الثالث', textFr: 'La Réserve fédérale signale des baisses de taux potentielles au T3', textTr: 'Federal Reserve signals potential rate cuts in Q3', textEs: 'La Reserva Federal señala posibles recortes de tasas en el Q3', link: null, publishedAt: null, impact: 'high', source: 'Fallback' },
    ...
    { category: 'Fed', categoryAr: 'الاحتياطي', categoryFr: 'Fed', categoryTr: 'Fed', categoryEs: 'Reserva Federal', color: T.gold, bgColor: '#d4af3712', text: 'Fed holds rates steady, hints at future cuts', textAr: 'الاحتياطي الفيدرالي يثبت الفائدة ويلوح بخفض مستقبلي', textFr: 'La Fed maintient les taux stables, laisse entrevenir des baisses futures', textTr: 'Fed holds rates steady, hints at future cuts', textEs: 'La Fed mantiene las tasas estables, sugiere futuros recortes', link: null, publishedAt: null, impact: 'high', source: 'Fallback' },
