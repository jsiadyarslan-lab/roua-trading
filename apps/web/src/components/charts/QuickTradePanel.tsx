  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 8, color: C.textMuted, fontFamily: "var(--font-ar)", marginBottom: 2 }}>
          {tc('currentPrice')}
        </div>
        <div style={{
      ...
      <div style={{ marginBottom: 6 }}>
        <label style={{ fontSize: 8, color: C.textMuted, fontFamily: "var(--font-ar)", display: 'block', marginBottom: 2 }}>
          {tc('quantity')}
        </label>
        <input
          type="number"
      ...
      <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
        <div style={{ flex: 1 }}>
          <label style={{ fontSize: 8, color: C.danger, fontFamily: "var(--font-mono)", display: 'block', marginBottom: 2 }}>
            {tc('stopLoss')}
          </label>
          <input
            type="number"
        ...
        <div style={{ flex: 1 }}>
          <label style={{ fontSize: 8, color: C.success, fontFamily: "var(--font-mono)", display: 'block', marginBottom: 2 }}>
            {tc('takeProfit')}
          </label>
          <input
            type="number"
