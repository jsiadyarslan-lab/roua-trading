...
export class OrderController {
  ...
  async placeOrder(@Req() req: any, @Body() body: V2PlaceOrderDto) {
    ...
    const command: OrderCommand = {
      ...
      symbol: body.symbol,
      side: body.side as unknown as OrderSideEnum,
      type: body.type as unknown as OrderTypeEnum,
      ...
      stopLoss: body.stopLoss != null ? (typeof body.stopLoss === 'string' ? parseFloat(body.stopLoss) : body.stopLoss) : 0,
      takeProfit: body.takeProfit != null ? (typeof body.takeProfit === 'string' ? parseFloat(body.takeProfit) : body.takeProfit) : undefined,
