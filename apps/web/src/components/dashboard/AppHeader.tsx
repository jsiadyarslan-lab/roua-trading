    ...
    <>
      ...
      {menuOpen && (
        <div style={{
          ...
          <div style={{
            position: 'absolute', top: 0, bottom: 0, width: 'min(280px, 85vw)',
            ...(isRtl ? { right: 0 } : { left: 0 }),
            background: 'rgba(26,29,41,0.95)',
            ...(isRtl ? { borderInlineStart: `1px solid rgba(0,212,255,0.12)` } : { borderInlineEnd: `1px solid rgba(0,212,255,0.12)` }),
            display: 'flex', flexDirection: 'column', padding: '20px',
            overflowY: 'auto',
            animation: isRtl ? 'slideInRight 0.3s cubic-bezier(0.4, 0, 0.2, 1)' : 'slideInLeft 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
