      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ color: C.text, fontWeight: 700, fontSize: 15, fontFamily: "var(--font-ar)", lineHeight: 1.2 }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                    ...
                    {state?.currentPrice != null && !state?.loading && (
                      <>
                        <span style={{ color: C.text, fontSize: 11, fontWeight: 600, fontFamily: "var(--font-mono)" }}>
                    ...
                    {state?.error && (
                      <span style={{ color: C.danger, fontSize: 11, fontFamily: "var(--font-ar)" }}>
                        {state.error}
                      </span>
                    )}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: 11, padding: 0, transition: 'all 0.15s ease',
                        flexShrink: 0,
                      }}
