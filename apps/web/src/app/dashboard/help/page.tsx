  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'نعم، يمكنك تفعيل التداول التلقائي من صفحة إعدادات الذكاء الاصطناعي إذا كنت مشتركاً في خطة PRO أو أعلى. يتيح لك التداول التلقائي تعيين قواعد محددة مثل مستوى الثقة الأدنى لتنفيذ الصفقات تلقائياً، الحد الأقصى لحجم المركز، وحد الخسارة اليومي. يتم تنفيذ الصفقات عبر حساب البورصة المربوط الخاص بك باستخدام صلاحيات API المحددة — المنصة لا تحتفظ بأموالك أبداً. ومع ذلك، ننصح بشدة بالبدء بمراقبة توصيات AI أولاً لفهم أسلوبها قبل تفعيل التنفيذ التلقائي. يمكنك أيضاً تشغيل البوت الذكي الذي يتبع استراتيجية محددة مع ضوابط مخاطرة صارمة.',
      },
      {
        id: 'a4',
