...
const EXPLANATIONS: Record<string, {
 ...
 factors: [
 { nameAr: ' level resistance', contributionAr: 'price above level high prior confirmation sie trade' },
 { nameAr: ' momentum', contributionAr: 'candles after break higher who level break' },
 ],
 invalidation: ' this break if price below level break ( test )',
 confirmation: ' break if price who level break support (retest) with sie trade good',
 },
 bearish: {
 ...
 { nameAr: 'weakness buyers', contributionAr: 'sie trading support fall' },
 ],
 invalidation: ' this break if price above level break',
 ...
 invalidation: ' if price low new less who low prior ( fall)',
 ...
 invalidation: ' if price high new higher who high prior',
 ...
 invalidation: ' if price below but — this about sellers ',
 confirmation: ' price who but with candle bullish strong sie trade ',
 },
 bearish: {
 ...
 invalidation: ' if price above but — buyers ',
 confirmation: ' price who but with candle bearish sie ',
 },
 },
 'harmonic': {
 bullish: {
 ...
 invalidation: ' if price level invalidation style (outside PRZ)',
 confirmation: ' he candle reversal strong at point D with sie ',
 },
 bearish: {
 ...
 invalidation: ' if price level point X (invalidation complete)',
 confirmation: ' candle bearish strong after point D with height sie trading',
 },
 },
 'wyckoff': {
 bullish: {
 ...
 invalidation: ' if price low all sie ',
 confirmation: ' resistance all (Sign of Strength) with sie ',
 },
 bearish: {
 ...
 invalidation: ' if price high sie ',
 confirmation: ' support with sie (Sign of Weakness)',
 },
 },
 'elliott': {
 bullish: {
 ...
 invalidation: ' if correct 100% who wave prior (rule )',
 ...
 invalidation: ' if price wave current',
...
export function explainSignal(opts: {
 ...
 confirmationAr: (typeof explanation === 'object' && explanation != null ? (explanation as any).confirmation : null) || ' price who one with sie ',
 relatedSignals,
