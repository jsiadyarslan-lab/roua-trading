  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 19, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)", margin: 0 }}>إعدادات النظام</h1>
          <p style={{ fontSize: 13, color: COLORS.muted, fontFamily: "var(--font-ar)", margin: '4px 0 0' }}>إدارة المفاتيح والتكوين والمخاطر</p>
        </div>
      ...
      {loading ? (
        <div style={{ ...CARD_STYLE, padding: 40, textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 13, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>جارٍ تحميل الإعدادات...</div>
        </div>
      ) : (
        <>
          {/* API Keys */}
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>مفاتيح API</span>
            </div>
            ...
            {apiKeys.length > 0 ? (
                ...
                {apiKeys.map(key => (
                  <div key={key.id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>{key.exchange}</div>
                        <div style={{ fontSize: 11, fontFamily: "var(--font-mono)", color: COLORS.muted }} dir="ltr">
                          {key.visible ? key.keyPreview.replace(/•/g, 'X') : key.keyPreview}
                        </div>
                      </div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ fontSize: 11, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>{formatLastValidated(key.lastValidated)}</span>
                      <button
              ...
              <div style={{
                ...
                <div style={{ fontSize: 11, color: COLORS.amber, fontFamily: "var(--font-ar)" }}>
          ...
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>تكوين البوت</span>
            </div>
          ...
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>إدارة المخاطر</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: COLORS.danger, fontFamily: "var(--font-ar)" }}>
                  {tn('hardCapsAdminTitle')}
                </span>
              </div>
              <div style={{ fontSize: 11, color: COLORS.muted, fontFamily: "var(--font-ar)", marginBottom: 12, lineHeight: 1.6 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  <input
                    ...
                    dir="ltr"
                  />
                  <span style={{ fontSize: 11, color: COLORS.muted, fontFamily: "var(--font-ar)" }}>
          ...
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>إعدادات الوكيل والمنفذ</span>
            </div>
            <div style={{ fontSize: 11, color: COLORS.muted, fontFamily: "var(--font-ar)", marginBottom: 14, lineHeight: 1.6 }}>
            ...
            {(() => {
              ...
              return isWarning ? (
                <div style={{
                  ...
                  <span style={{ fontSize: 11, color: COLORS.amber, fontFamily: "var(--font-ar)" }}>
            ...
            <div style={{ marginBottom: 16, padding: '10px 12px', borderRadius: 'var(--radius-md)', background: 'rgba(0,229,255,0.04)', border: `1px solid ${COLORS.accent}15` }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: COLORS.accent, fontFamily: "var(--font-ar)", marginBottom: 10 }}>
            ...
            <div style={{ padding: '10px 12px', borderRadius: 'var(--radius-md)', background: 'rgba(168,85,247,0.04)', border: '1px solid rgba(168,85,247,0.1)' }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#B388FF', fontFamily: "var(--font-ar)", marginBottom: 10 }}>
                🤖 الوكيل (Agent)
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[
          ...
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>🏛️ إعدادات مجلس الذكاء</span>
            </div>
            <div style={{ fontSize: 11, color: COLORS.muted, fontFamily: "var(--font-ar)", marginBottom: 14, lineHeight: 1.6 }}>
          ...
          <div style={{ ...CARD_STYLE, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>إعدادات المنصة</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 17, fontWeight: 700, color: COLORS.text, fontFamily: "var(--font-ar)" }}>إضافة مفتاح API جديد</span>
              </div>
              <button
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${COLORS.border}`,
                    background: 'transparent',
                    color: COLORS.muted, fontSize: 13, fontFamily: "var(--font-ar)",
                    cursor: 'pointer',
                  }}
                >
                  إلغاء
