...
export const INDICATOR_CONFIGS: IndicatorConfig[] = [
  // ── Overlay Indicators ──
  { key: 'sma',       label: 'المتوسط المتحرك البسيط', labelEn: 'SMA',     category: 'overlay',   defaultParams: { period: 20 },           defaultColor: '#FFB800', defaultOpacity: 0.8, paramConstraints: { period: { min: 2, max: 500 } } },
  { key: 'ema',       label: 'المتوسط الأسي',           labelEn: 'EMA',     category: 'overlay',   defaultParams: { period: 12 },           defaultColor: '#00D4FF', defaultOpacity: 0.7, paramConstraints: { period: { min: 2, max: 500 } } },
  ...
  { key: 'supertrend',label: 'سوبر ترند',               labelEn: 'SuperTrend', category: 'overlay',defaultParams: { period: 10, multiplier: 3 }, defaultColor: '#00D4FF', defaultOpacity: 0.7, paramConstraints: { period: { min: 2, max: 200 }, multiplier: { min: 0.5, max: 20, step: 0.1 } } },
  { key: 'pivot',     label: 'نقاط البايفوت',            labelEn: 'Pivot',   category: 'overlay',   defaultParams: {},                       defaultColor: '#B388FF', defaultOpacity: 0.6 },
  { key: 'donchian',  label: 'قناة دونشيان',             labelEn: 'Donchian', category: 'overlay',   defaultParams: { period: 20 },           defaultColor: '#FFB800', defaultOpacity: 0.5, paramConstraints: { period: { min: 2, max: 500 } } },
  ...
  { key: 'stochastic',label: 'الاستوكاستك',              labelEn: 'Stoch',   category: 'oscillator', defaultParams: { kPeriod: 14, dPeriod: 3 }, defaultColor: '#B388FF', defaultOpacity: 0.8, paramConstraints: { kPeriod: { min: 2, max: 200 }, dPeriod: { min: 1, max: 100 } } },
