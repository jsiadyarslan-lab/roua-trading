...
// Railway free-tier PostgreSQL (~25 max_connections).
// Also added connection_limit=1 and pool_timeout=10 to match the
// apps/web/src/lib/db.ts configuration.
// FIX: connection_limit reduced from 2 to 1 — Railway PostgreSQL has ~25
// max_connections and multiple pools are created during startup.
