...
const LABELS_AR: Record<string, string> = {
  'impulse-bullish':   'نبضة تصاعدية',
  'impulse-bearish':   'نبضة هبوطية',
  'zigzag-bullish':    'تصحيح زيگزاج صاعد',
  'zigzag-bearish':    'تصحيح زيگزاج هابط',
  'flat-bullish':      'تصحيح مسطح صاعد',
  'flat-bearish':      'تصحيح مسطح هابط',
  'triangle-bullish':  'تصحيح مثلث صاعد',
  'triangle-bearish':  'تصحيح مثلث هابط',
  'complex-bullish':   'تصحيح مركب صاعد',
  'complex-bearish':   'تصحيح مركب هابط',
};
