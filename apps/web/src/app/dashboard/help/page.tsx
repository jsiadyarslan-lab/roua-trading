...
import {
  ...
  Zap, Globe, RefreshCw, ExternalLink, Sparkles, X
} from 'lucide-react'
    ...
    items: [
      {
        ...
        answer: 'منصة رؤى هي منصة تداول ذكية متكاملة تجمع بين التحليل الفني المتقدم والذكاء الاصطناعي لمساعدتك في اتخاذ قرارات تداول أفضل. تعمل المنصة عن طريق ربط حسابك في البورصة عبر مفاتيح API آمنة، ثم تقوم بتحليل الأسواق في الوقت الحقيقي باستخدام نماذج AI متعددة مثل Gemini وGroq وGLM-4. توفر المنصة إشارات تداول ذكية، تحليل مخاطر متقدم، ونسخ صفقات احترافية كل ذلك في واجهة عربية سهلة الاستخدام.',
      },
      {
        id: 'b2',
        question: 'كيف أنشئ حساباً على منصة رؤى؟',
        answer: 'يمكنك إنشاء حساب مجاناً خلال دقائق معدودة عبر زيارة صفحة التسجيل وإدخال بريدك الإلكتروني وكلمة مرور قوية. بعد التسجيل، ستصلك رسالة تأكيد على بريدك الإلكتروني لتفعيل حسابك. يمكنك أيضاً التسجيل بسرعة عبر حساب Google الخاص بك. بعد التفعيل، يمكنك ربط بورصتك المفضلة مثل Binance أو Alpaca عبر مفاتيح API والبدء في استخدام أدوات التحليل والتداول الذكي فوراً.',
      },
      {
        id: 'b3',
        question: 'ما هي خطط الاشتراك المتاحة والفرق بينها؟',
        answer: 'نوفر أربع خطط اشتراك: المجانية (FREE) التي تمنحك وصولاً محدوداً للأدوات الأساسية والتداول الورقي، والاحترافية (PRO) التي تفتح التداول الحقيقي والإشارات الذكية، والبريميوم (PREMIUM) التي تضيف الذكاء الاصطناعي المتقدم ونسخ الصفقات، والمؤسسية (INSTITUTIONAL) المخصصة للمتداولين المحترفين مع وصول كامل لجميع الميزات. كل خطة تختلف في عدد الإشارات اليومية، نماذج AI المتاحة، صلاحيات API، وحدود التداول اليومية.',
      },
      {
        id: 'b4',
        question: 'هل يمكنني استخدام المنصة دون ربط بورصة؟',
        answer: 'نعم، بالتأكيد! يمكنك استخدام منصة رؤى دون ربط أي بورصة عبر وضع التداول الورقي (Paper Trading). يتيح لك هذا الوضع تجربة جميع أدوات التحليل والذكاء الاصطناعي بأموال افتراضية، مما يساعدك على تعلم المنصة واختبار استراتيجياتك قبل المخاطرة بأموال حقيقية. عندما تكون مستعداً للتداول الحقيقي، يمكنك ربط بورصتك بسهولة عبر صفحة الإعدادات مع الحفاظ على أعلى معايير الأمان.',
      },
    ],
  },
  {
    id: 'trading',
    title: 'التداول والتنفيذ',
    ...
    items: [
      {
        id: 't1',
        question: 'كيف أفتح صفقة تداول جديدة؟',
        answer: 'لفتح صفقة جديدة، انتقل إلى لوحة التداول واختر الزوج المالي الذي تريد تداوله من شريط البحث أو قائمة المراقبة. ثم حدد نوع الأمر (سوقي، محدد، أو وقف)، وحدد الكمية والرافعة المالية المرغوبة. يمكنك أيضاً تعيين وقف الخسارة وهدف الربح قبل التنفيذ. بعد مراجعة ملخص الصفقة الذي يظهر المخاطر المتوقعة، اضغط على زر التأكيد لتنفيذ الصفقة. يمكنك تفعيل خيار التأكيد التلقائي من الإعدادات إذا كنت تفضل التنفيذ السريع.',
      },
      {
        id: 't2',
        question: 'ما هي أوامر وقف الخسارة ووقف الخسارة المتحرك؟',
        answer: 'أمر وقف الخسارة (Stop Loss) هو أمر تلقائي يغلق صفقتك عندما يصل السعر إلى مستوى معين تحدده مسبقاً، مما يحميك من خسائر كبيرة. أما وقف الخسارة المتحرك (Trailing Stop) فهو أكثر ذكاءً، حيث يتبع حركة السعر لصالحك بمسافة محددة ولا يتحرك للخلف أبداً. مثلاً إذا اشتريت بسعر 100 وحددت trailing stop بنسبة 5%، فإذا ارتفع السعر إلى 120 سيكون وقف الخسارة عند 114، وإذا انخفض بعدها يبقى الوقف عند 114 مما يضمن لك أرباحاً جيدة.',
      },
      {
        id: 't3',
        question: 'كيف يعمل التداول الورقي (Paper Trading)؟',
        answer: 'التداول الورقي هو ميزة تتيح لك التداول بأموال افتراضية في ظروف سوق حقيقية تماماً. تحصل على محفظة ورقية برصيد افتراضي يمكنك استخدامها لفتح وإغلاق صفقات كما لو كنت تتداول بأموال حقيقية. الأسعار والإشارات和市场 البيانات كلها حقيقية، لكن الأموال افتراضية. هذا مفيد جداً للمبتدئين لتعلم أساسيات التداول، وللمحترفين لاختبار استراتيجيات جديدة دون مخاطرة مالية. يمكنك التبديل بين التداول الورقي والحقيقي بسهولة من شريط الأدوات.',
      },
      {
        id: 't4',
        question: 'كيف أدير مراكزي المفتوحة؟',
        answer: 'يمكنك إدارة جميع مراكزك المفتوحة من لوحة المراكز الموجودة أسفل الشارت أو في صفحة المراكز المخصصة. تعرض اللوحة تفاصيل كل مركز包括 سعر الدخول، الربح/الخسارة الحالي، نسبة التغير، والرافعة المستخدمة. يمكنك تعديل وقف الخسارة وهدف الربح لأي مركز مفتوح، أو إغلاق المركز جزئياً أو كلياً بنقرة واحدة. كما تتوفر أداة حاسبة المخاطر التي تساعدك في تقييم حجم المركز المناسب بناءً على رأس مالك ومستوى المخاطرة المقبول لديك.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: 'a3',
        question: 'هل يمكنني تفعيل التداول التلقائي بواسطة AI؟',
        answer: 'نعم، يمكنك تفعيل التداول التلقائي من صفحة إعدادات الذكاء الاصطناعي إذا كنت مشتركاً في خطة PRO أو أعلى. يتيح لك التداول التلقائي تعيين قواعد محددة مثل مستوى الثقة الأدنى لتنفيذ الصفقات تلقائياً، الحد الأقصى لحجم المركز، وحد الخسارة اليومي. ومع ذلك، ننصح بشدة بالبدء بمراقبة توصيات AI أولاً لفهم أسلوبها قبل تفعيل التنفيذ التلقائي. يمكنك أيضاً تشغيل البوت الذكي الذي يتبع استراتيجية محددة مع ضوابط مخاطرة صارمة.',
      },
      {
        id: 'a4',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'نعم، يمكنك إلغاء اشتراكك في أي وقت دون أي رسوم إضافية أو عقوبات. عند الإلغاء، يظل حسابك مفاعلاً بميزات الخطة الحالية حتى نهاية دورة الاشتراك المدفوعة. بعد انتهاء الدورة، يتم تحويل حسابك تلقائياً إلى الخطة المجانية مع الاحتفاظ بجميع بياناتك وسجل تداولاتك. يمكنك إعادة تفعيل الاشتراك في أي وقت مستقبلاً واستعادة جميع ميزاتك السابقة. لا نقوم بأي رسوم مخفية أو تجديد تلقائي بدون موافقتك المسبقة.',
      },
      {
        id: 'p3',
...
const quickLinks = [
  {
    ...
    description: 'ابدأ رحلتك مع منصة رؤى خطوة بخطوة من التسجيل حتى أول صفقة',
  ...
  },
  {
    id: 'trading-guide',
    title: 'دليل التداول',
    description: 'دليل شامل لأنواع الأوامر وإدارة المخاطر واستراتيجيات التداول المتقدمة',
